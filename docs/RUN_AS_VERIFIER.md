...
Expect: `tsc` silent, **110** tests passing. The suite includes red-then-green
...
the issuer recorded. Section 7 is what raises that to unconditional.
...
## 7. Pin the rail before you trust the extract
