...
abbrev: Cedulon
docname: draft-dogru-cedulon-06
date: 2026-08-31
category: info
submissiontype: IETF
ipr: trust200902
...
agent-spend receipts. This -06 does not claim IETF consensus.
...
: `kid` identifies the verification key. This -06 does not specify
...
: The receipt, checkpoint, extract, reconciliation, and verification
  ...
  describes, all three assert every case, 434 of 434, with none
...
threat-model MUST lines for them belong in later revisions (-07 or
later), written with the same discipline as this -06.
...
Payment is the special case that this -06 implements. The same
