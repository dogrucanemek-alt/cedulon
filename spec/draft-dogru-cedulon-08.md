...
abbrev: Cedulon
docname: draft-dogru-cedulon-08
date: 2026-09-02
category: info
submissiontype: IETF
ipr: trust200902
...
agent-spend receipts. This -08 does not claim IETF consensus.
...
: `kid` identifies the verification key. This -08 does not specify
...
: The receipt, checkpoint, extract, reconciliation, and verification
  ...
  describes, all three assert every case, 454 of 454, with none
...
threat-model MUST lines for them belong in later revisions (-09 or later), written with the same discipline as this -08.
...
Payment is the special case that this -08 implements. The same
