...
abbrev: Cedulon
docname: draft-dogru-cedulon-05
date: 2026-08-31
category: info
submissiontype: IETF
ipr: trust200902
...
agent-spend receipts. This -05 does not claim IETF consensus.
...
: `kid` identifies the verification key. This -05 does not specify
...
counterparty bindings, `deliveredHash`, and witness tier 2 - is
...
- "Allowed by policy" is stated as the Receipt Issuer's signed
  ...
  binding is a possible extension, not this revision.
...
threat-model MUST lines for them belong in later revisions (-06 or
later), written with the same discipline as this -05.
...
Payment is the special case that this -05 implements. The same
